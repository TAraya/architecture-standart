...
| P1  | Отклик по всем операциям должен быть максимально быстрым, 99% запросов должны укладываться в 900 миллисекнд, 75% запросов - в 500 миллисекунд |
...
| +S1 | Данные при передаче необходимо защитить механизмом шифрования | Допускается использование SFTP |
